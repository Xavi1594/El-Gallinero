...
.then((response) => response.json())
    .then((data) => {
      if(data.title) {
        articleToModify.articleObject = articleEdit;
...
<form>
    <div class="container mt-2">
      <div class="col-12 col-md-8">
        ...
        <button @click.prevent="update(articleData.id)" type="submit" class="btn btn-success me-2">
          Modificar
        </button>
